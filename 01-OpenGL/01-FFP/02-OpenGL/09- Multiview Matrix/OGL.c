...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_KEYDOWN:
        ...
        case VK_NUMPAD0:
        case 0x30:
            glViewport(0, 0, (GLsizei)width_updated, (GLsizei)height_updated);
            break;

        case VK_NUMPAD1:
        case 0x31:
            glViewport(0, 0, (GLsizei)width_updated / 2, (GLsizei)height_updated / 2);
            break;

        case VK_NUMPAD2:
        case 0x32:
            glViewport((GLsizei)width_updated / 2, 0, (GLsizei)width_updated / 2, (GLsizei)height_updated / 2);
            break;

        case VK_NUMPAD3:
        case 0x33:
            glViewport((GLsizei)width_updated / 2, (GLsizei)height_updated / 2, (GLsizei)width_updated / 2, (GLsizei)height_updated / 2);
            break;

        case VK_NUMPAD4:
        case 0x34:
            glViewport(0, (GLsizei)height_updated / 2, (GLsizei)width_updated / 2, (GLsizei)height_updated / 2);
            break;

        case VK_NUMPAD5:
        case 0x35:
            glViewport(0, 0, (GLsizei)width_updated, (GLsizei)height_updated / 2);
            break;

        case VK_NUMPAD6:
        case 0x36:
            glViewport(0, (GLsizei)height_updated / 2, (GLsizei)width_updated, (GLsizei)height_updated / 2);
            break;

        case VK_NUMPAD7:
        case 0x37:
            glViewport(0, 0, (GLsizei)width_updated / 2, (GLsizei)height_updated);
            break;

        case VK_NUMPAD8:
        case 0x38:
            glViewport((GLsizei)width_updated / 2, 0, (GLsizei)width_updated / 2, (GLsizei)height_updated);
            break;

        case VK_NUMPAD9:
        case 0x39:
            glViewport((GLsizei)width_updated / 4, (GLsizei)height_updated / 4, (GLsizei)width_updated / 2, (GLsizei)height_updated / 2);
            break;
...
void resize(width, height)
{
    ...
    fprintf(gpfile, "\nResized to width: %d, height: %d\n", width, height);
    height_updated = height;
    width_updated = width;
}
