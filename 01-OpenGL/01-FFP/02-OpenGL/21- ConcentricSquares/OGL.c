...
void Concentric_Squares(int );

BOOL concentric_square = FALSE;
...
void Concentric_Squares(int no_of_squares)
{
    if (no_of_squares == 0)
    {
        return;
    ...
    GLfloat step = 1.0f / no_of_squares;
