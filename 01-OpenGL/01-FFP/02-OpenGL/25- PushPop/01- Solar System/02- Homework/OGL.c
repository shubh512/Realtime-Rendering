...
void display(void)
{
    ...
    glPushMatrix();
    {
        ...
        // Rotate and translate for Earth's orbit
        glRotatef((GLfloat)year, 0.0f, 1.0f, 0.0f);
        glTranslatef(1.5f, 0.0f, 0.0f);

        glPushMatrix(); // Push matrix for Earth
        {
            // Rotate for Earth's day
            ...
            glPushMatrix(); // Push matrix for Moon
            {
                // Translate for Moon's orbit
            ...
            glPopMatrix(); // Pop matrix for Moon
        }
        glPopMatrix(); // Pop matrix for Earth
    }
    glPopMatrix();
