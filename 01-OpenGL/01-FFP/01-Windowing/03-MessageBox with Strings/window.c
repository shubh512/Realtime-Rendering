...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch(iMsg)
    {
        ...
        case WM_CREATE:
            MessageBox(hwnd, TEXT("WM_CREATE arrived"), TEXT("msg"), MB_OK);
            break;

        case WM_SIZE:
            MessageBox(hwnd, TEXT("WM_SIZE arrived"), TEXT("msg"), MB_OK);
            break;
        ...
        case WM_KEYDOWN:
            ...
            {
                case VK_ESCAPE:
                    MessageBox(hwnd, TEXT("WM_KEYDOWN VK_ESCAPE arrived"), TEXT("msg"), MB_OK);                   
                    break;
            }
            break;
        ...
        case WM_CHAR:
            ...
            {
                case 'F': // not working
                    MessageBox(hwnd, TEXT("WM_CHAR F key pressed"), TEXT("msg"), MB_OK);
                    break;
            }
            break;
